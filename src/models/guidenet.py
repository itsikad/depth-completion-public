# Original code from authors GitHub https://github.com/kakaxi314/GuideNet
# Replace authors CUDA implementation of guided convolution operator with 
# https://github.com/itsikad/guided-convolution
...
from guided_conv import GuidedChannelWiseConv2d
...
class Basic2dLocal(nn.Module):
    def __init__(self, out_channels, norm_layer=None):
        ...
        self.conv = GuidedChannelWiseConv2d(
...
class GuideNet(BaseModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        # Lidar encoder
        c0_lidar = self.conv_lidar(sdepth)
